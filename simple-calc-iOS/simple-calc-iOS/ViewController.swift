...
class ViewController: UIViewController {
    ...
    func doOp(op: op, first: Double?, second: Double?) -> Double {
        ...
        var resultString = "PlaceHolder"
        switch op {
        case .add:
            result = first + second
            resultString = "\(first) + \(second) = \(result ?? 0)"
        case .sub:
            result = first - second
            resultString = "\(first) - \(second) = \(result ?? 0)"
        case .mul:
        ...
        case .count:
            ...
            resultString = "\(opNumber) count = \(opNumber.count)"
        case .avg:
            var sum = 0.0
            ...
            resultString = "\(opNumber) avg = \(result ?? 0)"
        case .fact:
            result = floor(second) == second ? Double(fact(num: Int(floor(second)))) : 0
            resultString = "\(second) fact = \(result ?? 0)"
        default:
            result = 0
        }
